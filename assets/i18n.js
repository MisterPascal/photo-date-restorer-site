...
(function () {
  ...
  var T = {
    ...
    ru: {
      ...
      "benefits.b5.t": "Бесплатно: 100 файлов в день", "benefits.b5.b": "Восстанавливайте до 100 файлов бесплатно каждый день, чтобы проверить, подходит ли это вам.",
      ...
      "price.free.t": "Бесплатно", "price.free.price": "Бесплатно", "price.free.desc": "До 100 файлов в день",
      "price.free.l1": "До 100 файлов в день", "price.free.l2": "Предпросмотр найденных дат", "price.free.l3": "Без аккаунта",
      "price.full.badge": "Идеально для больших экспортов", "price.full.t": "Разовый пропуск: разблокировать всё", "price.full.price": "3,49 €", "price.full.desc": "Разовая покупка — без подписки",
      "price.full.l1": "Все фото и видео за один проход", "price.full.l2": "Разовая покупка, без подписки", "price.full.l3": "Идеально для больших экспортов и смены телефона",
      "price.note": "Хотите надолго? Дополнительная годовая подписка (2,99 €) открывает неограниченные запуски, пока активна.",
      ...
      "faq.q6": "Почему бесплатно 100 файлов в день?",
      "faq.a6": "Бесплатный уровень позволяет восстанавливать до 100 файлов каждый день, чтобы убедиться, что DateBack работает с вашими файлами, до покупки. Разовый пропуск (3,49 €) открывает один неограниченный запуск; годовая подписка (2,99 €) снимает лимит, пока активна.",
    ...
    hi: {
      ...
      "benefits.b5.t": "मुफ़्त: रोज़ 100 फ़ाइलें", "benefits.b5.b": "यह देखने के लिए कि यह आपके लिए काम करता है या नहीं, रोज़ 100 फ़ाइलों तक मुफ़्त बहाल करें।",
      ...
      "price.free.t": "मुफ़्त", "price.free.price": "मुफ़्त", "price.free.desc": "रोज़ 100 फ़ाइलों तक",
      "price.free.l1": "रोज़ 100 फ़ाइलों तक", "price.free.l2": "पहचानी गई तारीख़ों का पूर्वावलोकन", "price.free.l3": "कोई खाता नहीं चाहिए",
      "price.full.badge": "बड़े एक्सपोर्ट के लिए सर्वोत्तम", "price.full.t": "वन-टाइम पास: सब कुछ अनलॉक करें", "price.full.price": "€3.49", "price.full.desc": "एकमुश्त खरीद — कोई सदस्यता नहीं",
      "price.full.l1": "सभी फ़ोटो और वीडियो एक ही रन में", "price.full.l2": "एकमुश्त खरीद, कोई सदस्यता नहीं", "price.full.l3": "बड़े एक्सपोर्ट और फ़ोन बदलने के लिए सर्वोत्तम",
      "price.note": "कुछ स्थायी चाहिए? एक वैकल्पिक वार्षिक योजना (€2.99) सक्रिय रहने तक असीमित रन अनलॉक करती है।",
      ...
      "faq.q6": "रोज़ 100 फ़ाइलें मुफ़्त क्यों?",
      "faq.a6": "मुफ़्त स्तर आपको रोज़ 100 फ़ाइलों तक बहाल करने देता है ताकि खरीदने से पहले आप पुष्टि कर सकें कि DateBack आपकी फ़ाइलों के साथ काम करता है। एक वन-टाइम पास (€3.49) एक असीमित रन अनलॉक करता है; एक वार्षिक योजना (€2.99) सक्रिय रहने तक लिमिट हटाती है।",
    ...
    id: {
      ...
      "benefits.b5.t": "Gratis: 100 file per hari", "benefits.b5.b": "Pulihkan hingga 100 file gratis setiap hari untuk melihat apakah cocok untuk Anda.",
      ...
      "price.free.t": "Gratis", "price.free.price": "Gratis", "price.free.desc": "Hingga 100 file per hari",
      "price.free.l1": "Hingga 100 file per hari", "price.free.l2": "Pratinjau tanggal terdeteksi", "price.free.l3": "Tanpa akun",
      "price.full.badge": "Terbaik untuk ekspor besar", "price.full.t": "Pass sekali bayar: buka semua", "price.full.price": "€3.49", "price.full.desc": "Pembelian sekali — tanpa langganan",
      "price.full.l1": "Semua foto dan video dalam satu proses", "price.full.l2": "Pembelian sekali, tanpa langganan", "price.full.l3": "Terbaik untuk ekspor besar dan ganti ponsel",
      "price.note": "Ingin yang berkelanjutan? Paket tahunan opsional (€2.99) membuka proses tanpa batas selama aktif.",
      ...
      "faq.q6": "Mengapa 100 file gratis per hari?",
      "faq.a6": "Tingkat gratis memungkinkan Anda memulihkan hingga 100 file setiap hari, agar Anda dapat memastikan DateBack bekerja dengan file Anda sebelum membeli. Pass sekali bayar (€3.49) membuka satu proses tanpa batas; paket tahunan (€2.99) menghapus batas selama aktif.",
    ...
    ja: {
      ...
      "benefits.b5.t": "無料：1 日 100 ファイル", "benefits.b5.b": "毎日 100 ファイルまで無料で復元して、あなたに合うか試せます。",
      ...
      "price.free.t": "無料", "price.free.price": "無料", "price.free.desc": "1 日 100 ファイルまで",
      "price.free.l1": "1 日 100 ファイルまで", "price.free.l2": "検出した日付のプレビュー", "price.free.l3": "アカウント不要",
      "price.full.badge": "大量の書き出しに最適", "price.full.t": "ワンタイムパス：すべて解放", "price.full.price": "€3.49", "price.full.desc": "買い切り——サブスクなし",
      "price.full.l1": "すべての写真と動画を一度の実行で", "price.full.l2": "買い切り、サブスクなし", "price.full.l3": "大量の書き出しや機種変更に最適",
      "price.note": "継続して使いたい場合は、任意の年間プラン（€2.99）が有効な間は無制限の実行を解放します。",
      ...
      "faq.q6": "なぜ 1 日 100 ファイルが無料なのですか？",
      "faq.a6": "無料枠では毎日 100 ファイルまで復元でき、購入前に DateBack があなたのファイルで動くか確認できます。ワンタイムパス（€3.49）は無制限の実行を 1 回解放し、年間プラン（€2.99）は有効な間ずっと上限を解除します。",
    ...
    ko: {
      ...
      "benefits.b5.t": "무료: 하루 100개 파일", "benefits.b5.b": "매일 100개 파일까지 무료로 복원해 자신에게 맞는지 확인하세요.",
      ...
      "price.free.t": "무료", "price.free.price": "무료", "price.free.desc": "하루 100개 파일까지",
      "price.free.l1": "하루 100개 파일까지", "price.free.l2": "감지된 날짜 미리보기", "price.free.l3": "계정 불필요",
      "price.full.badge": "대량 내보내기에 적합", "price.full.t": "원타임 패스: 모두 잠금 해제", "price.full.price": "€3.49", "price.full.desc": "일회성 구매 — 구독 없음",
      "price.full.l1": "모든 사진과 동영상을 한 번의 실행으로", "price.full.l2": "일회성 구매, 구독 없음", "price.full.l3": "대량 내보내기와 휴대폰 교체에 적합",
      "price.note": "계속 사용하고 싶으세요? 선택형 연간 플랜(€2.99)은 활성화된 동안 무제한 실행을 제공합니다.",
      ...
      "faq.q6": "왜 하루 100개 파일이 무료인가요?",
      "faq.a6": "무료 등급에서는 매일 100개 파일까지 복원할 수 있어 구매 전에 DateBack이 파일과 작동하는지 확인할 수 있습니다. 원타임 패스(€3.49)는 무제한 실행 1회를 잠금 해제하고, 연간 플랜(€2.99)은 활성화된 동안 제한을 없앱니다.",
    ...
    zh: {
      ...
      "benefits.b5.t": "免费：每天 100 个文件", "benefits.b5.b": "每天可免费恢复多达 100 个文件，看看是否适合你。",
      ...
      "price.free.t": "免费", "price.free.price": "免费", "price.free.desc": "每天最多 100 个文件",
      "price.free.l1": "每天最多 100 个文件", "price.free.l2": "预览检测到的日期", "price.free.l3": "无需账户",
      "price.full.badge": "适合大批量导出", "price.full.t": "一次性通行证：解锁全部", "price.full.price": "€3.49", "price.full.desc": "一次性购买——无订阅",
      "price.full.l1": "一次操作处理所有照片和视频", "price.full.l2": "一次性购买，无订阅", "price.full.l3": "适合大批量导出和换机",
      "price.note": "想长期使用？可选的年度套餐（€2.99）在有效期内解锁无限次操作。",
      ...
      "faq.q6": "为什么每天 100 个文件免费？",
      "faq.a6": "免费层让你每天恢复多达 100 个文件，以便在购买前确认 DateBack 适用于你的文件。一次性通行证（€3.49）解锁一次无限制操作；年度套餐（€2.99）在有效期内取消限制。",
    ...
    ar: {
      ...
      "benefits.b5.t": "مجانًا: 100 ملف يوميًا", "benefits.b5.b": "استعِد حتى 100 ملف مجانًا كل يوم لترى إن كان مناسبًا لك.",
      ...
      "price.free.t": "مجانًا", "price.free.price": "مجانًا", "price.free.desc": "حتى 100 ملف يوميًا",
      "price.free.l1": "حتى 100 ملف يوميًا", "price.free.l2": "معاينة التواريخ المكتشفة", "price.free.l3": "بدون حساب",
      "price.full.badge": "الأفضل لعمليات التصدير الكبيرة", "price.full.t": "تصريح لمرة واحدة: افتح كل شيء", "price.full.price": "€3.49", "price.full.desc": "شراء لمرة واحدة — بدون اشتراك",
      "price.full.l1": "كل الصور والفيديوهات في تشغيل واحد", "price.full.l2": "شراء لمرة واحدة، بدون اشتراك", "price.full.l3": "الأفضل لعمليات التصدير الكبيرة وتغيير الهاتف",
      "price.note": "تريد شيئًا مستمرًا؟ خطة سنوية اختيارية (€2.99) تفتح عمليات غير محدودة ما دامت نشطة.",
      ...
      "faq.q6": "لماذا 100 ملف مجانًا يوميًا؟",
      "faq.a6": "تتيح لك الفئة المجانية استعادة حتى 100 ملف كل يوم لتتأكد من أن DateBack يعمل مع ملفاتك قبل الشراء. يفتح التصريح لمرة واحدة (€3.49) تشغيلًا واحدًا غير محدود؛ وتزيل الخطة السنوية (€2.99) الحد ما دامت نشطة.",
